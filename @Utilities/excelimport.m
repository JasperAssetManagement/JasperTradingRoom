function data = excelimport(filename,sheet,firstrow,lastrow, varargin)
...
%  outputAsChar: true / false value indicating whether the data should be output as characters.
%               If set to false the function attempts to convert each
%               column into a numeric array, default false
%
% Example:
% data = excelimport('Book1.xlsx',1,2,2000,'columns',[1 4 700],'outputAsChar',true);

% Are Mjaavatten, 2016-03-15
% modified by Neo lin, 2017-05-05
