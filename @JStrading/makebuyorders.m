function makebuyorders(chFile,tOrders)
...
if any(tOrders.qty<0)
    error('bad input: short orders detected')
end
...
switch tpTradeType
    case 'fc' % 一创
        ...
        tOrders.price = repmat({'买一'},numel(tOrders.windcode),1);
    ...
    case 'o32' % 恒生O32或恒投
        ...
        tOrders.direction = 1*ones(numel(tOrders.windcode),1);
