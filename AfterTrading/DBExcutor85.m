...
%data：cell数组
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ data ] = DBExcutor85( parameterSql )
%设置建立连接的最长时间，如果超过5秒内还未建立，则连接失败
timeoutA=logintimeout(5);

% 建立一个连接，其中RTDB为ODBC数据源名称，Administrator为用户名 112358为密码
%这个链接的是SQL server数据库
connA=database('windfilesync','IRUser','wR8MQehX','com.microsoft.sqlserver.jdbc.SQLServerDriver','jdbc:sqlserver://jasperam.sqlserver.rds.aliyuncs.com:3433;databaseName=windfilesync');
