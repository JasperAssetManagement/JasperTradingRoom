...
if 1==f_calPnl
    ...
    f_updateDB=1;
    subAccounts=['88'];%计算部分账户时对应的产品ID
    aCap.accounts=['80AJD'];%对应需要调整规模账户的ID
    aCap.capitals=[268011470];
    % 计算pos trading pnl
...
%     JasperTradingRoom.calAShareReturn(s_date,'JASON');
    ids = {'88';'86';'80T0';'82T0';'91T0';'55T0';'55JD';'79JD';'85AJD';'91JD';'64AJD';'84JD';'93AJD';'93A';'93'};%'88';'86';'80T0';'82T0';'91T0';'55T0';'55JD';'79JD';'85AJD';'91JD';'64AJD';'84JD';'93AJD';'93A';'93';
    for i=1:length(ids)
        s_id=ids{i};
